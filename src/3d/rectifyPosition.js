...
function RectifyGetData (){
	let data = {
		...
		"A2": {
			...
			area: [[0,602.50],[304.70,688.90],[288.90,688.90],[0,610.40]],
		...
		"A3": {
			...
			area: [[0,579.20],[390.60,688.90],[304.70,688.90],[0,602.50]],
			// realCoordinate: [{x:34982,y:589967},{x:276910,y:676195}],
			realCoordinate: [{x:34982,y:589967},{x:277500,y:673000}],
		...
		"A71": {
			area: [[67.70, 489.90],[75.30,492.10],[68.90,515.00],[61.30,512.90]],
			realCoordinate: [{x:67700,y:489900},{x:68900,y:515000}],
			modelCoordinate: [{x:-4354.7742,y:-2123.2245},{x:-4235.64914,y:-1860.60731}],
			room: "碎石配料间-西"
		},
		//A9
		"A8": {
		...
		"A81": {
			area: [[235.90,420.60],[259.50,427.20],[256.30,438.80],[232.60,432.20]],
			realCoordinate: [{x:235900,y:420600},{x:256300,y:438800}],
			modelCoordinate: [{x:-2883.81716,y:-3241.43465},{x:-2630.88564,y:-3113.949}],
			room: "筛分间"
		},
		"A82": {
			area: [[232.60,359.70],[253.40,365.60],[249.40,380.90],[228.30,375.00]],
			realCoordinate: [{x:232600,y:359700},{x:249400,y:380900}],
			modelCoordinate: [{x:-2847.64406,y:-3865.27102},{x:-2623.64412,y:-3690.90792}],
			room: "破碎间"
		},
		/* 
		"A1": {
